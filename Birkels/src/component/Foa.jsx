...
import mobileImg from '../assets/Component.svg'
...
const Foa = () => {
  ...
  return (
    <>
      <div
        className="w-full bg-cover bg-center  w-[1280px]
        
        h-[1653px] w-[1280px]relative py-[100px] px-4 sm:px-8"
        style={{
      ...
      >
        ...
        {/* Content container */}
        <div className="relative z-10 max-w-[1200px] h-[1453px] mx-auto flex flex-col gap-[50px]">
          ...
          {/* FAQ Accordions */}
          <div className="w-full mx-auto flex text-[14px] justify-center flex-col gap-8 items-center text-white px-4 sm:px-8">
            {faqs.map((item, index) => (
              <div
                key={index}
                className="w-[1120px] bg-gradient-to-r from-[#00143D]/80 to-[#00297A]/80 backdrop-blur-md rounded-lg border border-white/30 p-4 text-[16px] transition-all duration-300"
              >
                <div
