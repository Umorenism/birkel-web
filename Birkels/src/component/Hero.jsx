...
export default function Hero() {
  return (
    <div className="w-full bg-[#f9f9f9] sm:py-[50px] py-10 px-5 sm:px-0">
      <div
        style={{ backgroundImage: `url(${bgImage})` }}
        className="max-w-[1120px] sm:h-[774px] h-[665px] mx-auto bg-cover bg-center bg-no-repeat rounded-[50px] shadow-lg relative flex items-center justify-center text-center px-4"
      >
