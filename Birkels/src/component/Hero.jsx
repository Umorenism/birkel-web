  ...
  return (
    <div className="w-full bg-[#f9f9f9] sm:py-[50px] py-10 px-5 sm:px-0">
      <div
        ...
        className="max-w-[1200px] sm:h-[774px] h-[665px] flex-col mx-auto bg-cover bg-center bg-no-repeat rounded-[50px] shadow-lg relative flex items-center justify-center text-center px-4"
      >
        {/* Dark overlay for readability */}
        <div className="absolute inset-0  bg-opacity-40 z-0" />

        {/* Content */}
        <div className="relative z-10 text-white max-w-[820px] w-full h-[303px] space-y-[35px] px-4">
          ...
          <div className="w-full flex items-center justify-center">
            <a href="tel:+1234567890">
              ...
              <div className="sm:w-[150px] w-[150px] h-[48px] rounded-full flex items-center justify-center bg-white/10 backdrop-blur-sm shadow-md">
                <button
